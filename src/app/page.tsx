    ...
    <div className="min-h-screen bg-[#01040D] text-slate-200 font-sans selection:bg-pink-500/30 overflow-x-hidden">
              ...
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    >
                      {loading ? 'Processing...' : (activeTier === 'T0' ? 'Request Access' : 'Join Waitlist')}
                    </button>
                  </form>
                </>
              ) : (
        ...
        >
          ...
          <div className={`hidden md:flex items-center space-x-8 text-[10px] font-black uppercase tracking-widest text-slate-400 transition-all duration-500 ${scrolled ? 'opacity-100' : 'opacity-80'}`}>
            {['concept', 'tech', 'pricing'].map((item) => (
              <a key={item} href={`#${item}`} title={`Navigate to ${item}`} className="hover:text-white transition-colors duration-300 relative group py-2">
                {item.toUpperCase()}
            ...
            <Link href="/blog" title="Read Kairi Kana Blog" className="hover:text-white transition-colors duration-300 relative group py-2">
              BLOG
              <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gradient-to-r from-pink-500 to-purple-600 transition-all duration-300 group-hover:w-full"></span>
            </Link>
          </div>
          ...
          <div className="flex items-center gap-5">
            ...
            <div className="hidden md:flex items-center space-x-2 text-[10px] font-bold">
              ...
              <Link href="/id" title="Bahasa Indonesia version" className="text-slate-500 hover:text-white transition-colors">Id</Link>
            </div>
            ...
            <div className="md:hidden flex items-center space-x-3">
              {!scrolled && (
                <>
                  <Link href="/blog" title="Read Kairi Kana Blog" className="text-slate-400 hover:text-pink-500 transition-colors text-[10px] font-black uppercase tracking-widest">Blog</Link>
                  <span className="text-white/10">|</span>
                </>
              )}
              <span className="text-pink-500 font-bold text-xs cursor-default">En</span>
              <span className="text-white/20">|</span>
              <Link href="/id" title="Bahasa Indonesia version" className="text-slate-400 hover:text-white transition-colors text-xs">Id</Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-24">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-xl text-slate-400 max-w-xl mb-12 leading-relaxed font-medium">
              You don&#39;t need another complex app to kill the chaos. You need an assistant that lives where you do. Snap your world and let Kairi organize your life.
            </motion.p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[minmax(0,1fr)]">
            {[
              ...
              },
              {
                ...
                title: "Gamified Flow",
                desc: "Collect points by completing your tasks. Await MILESTONE REWARDS: renewal discounts, tier upgrades, or exclusive perks.",
              ...
              >
                ...
                {i === 1 && (
                  <div className="mt-8 flex gap-2">
                    ...
                    <span className="text-[10px] font-bold text-purple-400">POINTS</span>
                  </div>
                )}
              </SpotlightCard>
            ))}
      ...
      <footer className="py-24 px-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
        ...
        <div className="flex gap-12 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em] flex-wrap justify-center">
          <Link href="/blog" title="Read Kairi Kana Blog" className="hover:text-pink-500 transition-colors duration-300">Blog</Link>
          <a href="/privacy" title="Kairi Kana Privacy Policy" className="hover:text-pink-500 transition-colors duration-300">Privacy Policy</a>
          <a href="/terms" title="Kairi Kana Terms and Conditions" className="hover:text-purple-500 transition-colors duration-300">Terms & Conditions</a>
          <a href="/refund" title="Kairi Kana Refund Policy" className="hover:text-blue-500 transition-colors duration-300">Refund Policy</a>
          <a href="https://wa.me/6285753442122" target="_blank" rel="noopener noreferrer" title="Contact Kairi Kana via WhatsApp" className="hover:text-green-500 transition-colors duration-300">Contact Us</a>
        </div>

        {/* Socials */}
        <div className="flex gap-6 items-center">
          <a href="https://www.instagram.com/ace_elevate.ai?igsh=MXBtNXNqMHpuajZhaQ==" target="_blank" rel="noopener noreferrer" title="Follow Ace Elevate on Instagram" aria-label="Follow us on Instagram" className="text-slate-500 hover:text-pink-500 transition-all duration-300 transform hover:scale-110">
            <Instagram size={20} />
          </a>
          <a href="https://www.tiktok.com/@acelevate.ai" target="_blank" rel="noopener noreferrer" title="Follow Ace Elevate on TikTok" aria-label="Follow us on TikTok" className="text-slate-500 hover:text-purple-500 transition-all duration-300 transform hover:scale-110">
            <TikTokIcon size={20} />
          </a>
          <a href="https://wa.me/6285753442122" target="_blank" rel="noopener noreferrer" title="Contact Kairi Kana on WhatsApp" aria-label="Contact us on WhatsApp" className="text-slate-500 hover:text-green-500 transition-all duration-300 transform hover:scale-110">
