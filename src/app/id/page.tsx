          ...
          `}
                >
                    ...
                    <div className={`hidden md:flex items-center space-x-8 text-[10px] font-black uppercase tracking-widest text-slate-400 transition-all duration-500 ${scrolled ? 'opacity-100' : 'opacity-80'}`}>
                        {['konsep', 'teknologi', 'harga'].map((item) => (
                            <a key={item} href={`#${item}`} title={`Navigasi ke ${item}`} className="hover:text-white transition-colors duration-300 relative group py-2">
                        ...
                        <Link href="/id/blog" title="Baca Blog Kairi Kana" className="hover:text-white transition-colors duration-300 relative group py-2">
                            BLOG
                            <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-gradient-to-r from-pink-500 to-purple-600 transition-all duration-300 group-hover:w-full"></span>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-5">
                        ...
                        <div className="hidden md:flex items-center space-x-2 text-[10px] font-bold">
                            <Link href="/" title="English version" className="text-slate-500 hover:text-white transition-colors">En</Link>
                        ...
                        <div className="md:hidden flex items-center space-x-3">
                            {!scrolled && (
                                <>
                                    <Link href="/id/blog" title="Baca Blog Kairi Kana" className="text-slate-400 hover:text-pink-500 transition-colors text-[10px] font-black uppercase tracking-widest">Blog</Link>
                                    <span className="text-white/10">|</span>
                                </>
                            )}
                            <Link href="/" title="English version" className="hover:text-white transition-colors text-xs">En</Link>
                            <span className="text-white/20">|</span>
                    ...
                    <div className="flex flex-col lg:flex-row gap-20 items-center">
                        <div className="lg:w-1/2">
                            ...
                            <p className="text-lg text-slate-400 leading-relaxed mb-10">
                                Kairi Kana bukan sekadar chatbot. Dia adalah Agentic AI yang ditenagai oleh <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-blue-400 font-black">16 agen inti khusus</span>. Dari audit pengeluaran hingga pemetaan jadwal, setiap agen bekerja harmonis menjaga konteks pribadimu tanpa halusinasi.
                            </p>
                                ...
                                {(() => {
                                    ...
                                    return (
                                        <svg viewBox="0 0 400 400" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                                            <style>{`
                                                .pcb-trace-id{stroke-dasharray:5 4;animation:trFlowId 2.5s linear infinite}
                                                .pcb-mesh-id{opacity:.18}
                                                .k-center-id{animation:kPulseId 3s ease-in-out infinite}
                                                @keyframes trFlowId{to{stroke-dashoffset:-18}}
                                                @keyframes kPulseId{0%,100%{filter:drop-shadow(0 0 6px rgba(168,85,247,.12))}50%{filter:drop-shadow(0 0 22px rgba(168,85,247,.45))}}
                                            `}</style>
                                            <defs>
                                                <linearGradient id="tgId" x1="0" y1="0" x2="1" y2="1">
                                                ...
                                                <linearGradient id="kBgId" x1="0" y1="0" x2="1" y2="1">
                                                    <stop offset="0%" stopColor="#0c1222" />
                                                    <stop offset="50%" stopColor="#111827" />
                                                    <stop offset="100%" stopColor="#0c1222" />
                                                </linearGradient>
                                                <linearGradient id="kTxId" x1="0" y1="0" x2="1" y2="0">
                                            ...
                                            {cores.map(([x, y], i) => (
                                                <line key={`h${i}`} x1={200} y1={200} x2={x} y2={y} stroke="url(#tgId)" strokeWidth="0.8" className="pcb-trace-id" style={{ animationDelay: `${i * .15}s` }} />
                                            ))}
                                            {mesh.map(([a, b], i) => (
                                                <line key={`m${i}`} x1={cores[a][0]} y1={cores[a][1]} x2={cores[b][0]} y2={cores[b][1]} stroke="url(#mgId)" strokeWidth="0.6" className="pcb-mesh-id" />
                                            ))}
                                            ...
                                            <g className="k-center-id">
                                                ...
                                                <rect x={180} y={180} width={40} height={40} rx={5} fill="url(#kBgId)" stroke="#64748b" strokeWidth={1.2} />
                                                ...
                                                <text x={200} y={198} textAnchor="middle" dominantBaseline="middle" fill="url(#kTxId)" fontSize="22" fontWeight="900" fontStyle="italic" fontFamily="system-ui,sans-serif">K</text>
            ...
            <footer className="py-24 px-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-12 text-center md:text-left">
                ...
                <div className="flex gap-12 text-[9px] font-black text-slate-600 uppercase tracking-[0.3em] flex-wrap justify-center">
                    <Link href="/id/blog" title="Baca Blog Kairi Kana" className="hover:text-pink-500 transition-colors duration-300">Blog</Link>
                    <a href="/id/privacy" title="Kebijakan Privasi Kairi Kana" className="hover:text-pink-500 transition-colors duration-300">Privasi</a>
                    <a href="/id/terms" title="Syarat dan Ketentuan Kairi Kana" className="hover:text-purple-500 transition-colors duration-300">Syarat</a>
                    <a href="/id/refund" title="Kebijakan Pengembalian Dana Kairi Kana" className="hover:text-blue-500 transition-colors duration-300">Kebijakan Pengembalian Dana</a>
                    <a href="https://wa.me/6285753442122" target="_blank" rel="noopener noreferrer" title="Hubungi Kairi Kana via WhatsApp" className="hover:text-green-500 transition-colors duration-300">Hubungi Kami</a>
                </div>

                {/* Socials */}
                <div className="flex gap-6 items-center">
                    <a href="https://www.instagram.com/ace_elevate.ai?igsh=MXBtNXNqMHpuajZhaQ==" target="_blank" rel="noopener noreferrer" title="Ikuti Ace Elevate di Instagram" aria-label="Ikuti kami di Instagram" className="text-slate-500 hover:text-pink-500 transition-all duration-300 transform hover:scale-110">
                        <Instagram size={20} />
                    </a>
                    <a href="https://www.tiktok.com/@acelevate.ai" target="_blank" rel="noopener noreferrer" title="Ikuti Ace Elevate di TikTok" aria-label="Ikuti kami di TikTok" className="text-slate-500 hover:text-purple-500 transition-all duration-300 transform hover:scale-110">
                        <TikTokIcon size={20} />
                    </a>
                    <a href="https://wa.me/6285753442122" target="_blank" rel="noopener noreferrer" title="Hubungi Kairi Kana di WhatsApp" aria-label="Hubungi kami di WhatsApp" className="text-slate-500 hover:text-green-500 transition-all duration-300 transform hover:scale-110">
