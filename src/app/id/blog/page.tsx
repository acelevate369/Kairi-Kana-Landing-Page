...
export const metadata: Metadata = {
    title: 'Blog - Wawasan & Artikel',
    description: 'Jelajahi artikel tentang produktivitas AI, pertumbuhan pribadi, manajemen keuangan, dan cara mengoptimalkan hidupmu dengan Kairi Kana.',
    keywords: ['Blog Kairi Kana', 'Produktivitas AI', 'Pertumbuhan Diri', 'Manajemen Keuangan', 'AI Agen'],
    openGraph: {
        title: 'Blog - Kairi Kana',
        description: 'Jelajahi artikel tentang produktivitas AI, pertumbuhan pribadi, dan manajemen keuangan.',
        ...
        <div className="min-h-screen bg-[#01040D] text-slate-200 font-sans selection:bg-pink-500/30">
            ...
            <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6">
                <div className="flex justify-between items-center w-full max-w-7xl py-4 px-6">
                    <Link href="/id" className="flex items-center space-x-3 group">
                    ...
                    <div className="flex items-center gap-5">
                        <div className="flex items-center space-x-2 text-[10px] font-bold">
                            <Link href="/blog" className="text-slate-500 hover:text-white transition-colors">En</Link>
                            <span className="text-white/20">|</span>
                            <span className="text-white cursor-default">Id</span>
                        </div>
                        <Link
                            href="/id"
            ...
            <section className="pt-40 pb-16 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    <div className="inline-flex items-center space-x-2 bg-white/5 border border-white/10 px-4 py-2 rounded-full mb-8">
                        ...
                        <span className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400 italic">Wawasan & Artikel</span>
                    </div>
                ...
                <div className="max-w-5xl mx-auto">
                    {posts.length === 0 ? (
                        <div className="text-center py-24">
                            ...
                            <p className="text-slate-500 font-bold uppercase tracking-widest text-sm">Belum ada artikel</p>
                            <p className="text-slate-700 text-xs mt-2">Konten baru sedang dalam perjalanan. Nantikan ya.</p>
                        </div>
                    ) : (
